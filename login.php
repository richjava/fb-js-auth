...
<html>
    <head>
        <title>Login | Facebook JavaScript Login Example</title>
        <meta charset="UTF-8">
        <!-- Bootstrap core CSS -->
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-signin" _lpchecked="1">
                ...
                <button class="btn btn-sm btn-primary btn-block" onclick="fbLogin();" type="submit">Sign in using Facebook</button>
            </form>
        </div>
